...
model = dict(
    ...
    lm_head=None,
    use_lora=False,
    use_student_decoder=True,
    student_model_path=None,
    pretrained=dict(img='/mnt/adas7tb/jgu/Orion/ckpts/eva02_petr_proj.pth'),
    compile_img_backbone=True,
    compile_img_backbone_mode='default',
    compile_img_backbone_backend='inductor',
...
train_pipeline = [
    ...
    dict(type='CustomCollect3D',\
         keys=['gt_bboxes_3d', 'gt_labels_3d', 'img', 'ego_his_trajs','gt_attr_labels', 'ego_fut_trajs', 'ego_fut_masks','ego_fut_cmd', 'ego_lcf_feat','can_bus', 'traffic_state_mask', 'traffic_state']+collect_keys),
]
...
optimizer = dict(constructor='LearningRateDecayOptimizerConstructor', type='AdamW', 
                 lr=2e-5, betas=(0.9, 0.999), weight_decay=1e-5,
