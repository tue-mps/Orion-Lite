...
data_root = "/mnt/adas7tb/jgu/Orion/distill/mini_data/bench2drive"
info_root = "/mnt/adas7tb/jgu/Orion/distill/mini_data/infos"
map_root = "/mnt/adas7tb/jgu/Orion/distill/mini_data/bench2drive/maps"
map_file = "/mnt/adas7tb/jgu/Orion/distill/mini_data/infos/b2d_map_infos.pkl"
    ...
    dict(
        ...
        transforms=[
            ...
            dict(
                ...
                keys=['gt_bboxes_3d', 'gt_labels_3d', 'img', 'ego_his_trajs','input_ids','gt_attr_labels', 'ego_fut_trajs', 'ego_fut_masks','ego_fut_cmd', 'ego_lcf_feat','vlm_labels','can_bus','traffic_state_mask', 'traffic_state','fut_valid_flag']+collect_keys,
            )]
    )
]
