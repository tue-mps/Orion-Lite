...
use_memory = True
# CHANGED: Use fp16 for distilled model inference
fp16_infer = True 
num_gpus = 32
batch_size = 4
...
model = dict(
    ...
    student_model_path='/mnt/adas7tb/jgu/Orion/distill/runs/orion_student_with_mimic_loss/checkpoints/last.pt',
    ...
    use_grid_mask=True,
    fp16_infer=fp16_infer, # True
    fp16_eval=False,  # CHANGED: Set to False for closed-loop testing to avoid loading GT
    frozen=False,
    use_lora=True,
    # tokenizer=llm_path, # REMOVED
