...
log_level = 'INFO'
work_dir = 'adzoo/orion/work_dirs/exp7_exp8_two_stage_20260226_090919/exp7_stage2'
load_from = 'adzoo/orion/work_dirs/exp7_exp8_two_stage_20260226_090919/exp7_stage1/latest.pth'
resume_from = None
workflow = [('train', 1)]
...
model = dict(
    ...
    student_cfg=dict(
        ...
        num_heads=16,
        dropout=0.1),
    img_backbone_ckpt='/data/video-fm/datasets/jgu/Orion/ckpts/Orion.pth',
    img_backbone_prefix='img_backbone.',
    orion_ckpt_load_mode='except_student')
